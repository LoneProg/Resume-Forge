...
export default function HeroSection() {
    ...
    return (
        <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            <motion.a href="#" className="group flex items-center gap-2 rounded-full p-1 pr-3 mt-44 text-purple-100 bg-purple-200/15"
            ...
            >
                Create resumes that{" "}
                <span className="move-gradient px-3 rounded-xl text-nowrap">Lands Interviews</span>
            </motion.h1>
            <motion.p className="text-base text-center text-slate-200 max-w-lg mt-6"
                ...
                transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
            >
                No complexity. No noise. Just clean, reliable automation to boost your Career.</motion.p>
